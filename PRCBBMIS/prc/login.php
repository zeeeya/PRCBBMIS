...
<center>
    ...
    <div class="tb1">
        ...
        &nbsp;&nbsp;&nbsp; Username &nbsp;
        <input class="urmfld" type="text" name="username" placeholder="&nbsp;Enter Username" required autofocus=""/>
        <br><br>
        &nbsp;&nbsp;&nbsp; Password &nbsp;
        <input class="pwdfld" type="password" name="password" placeholder="&nbsp;**********" required/>
        <br>
        <br>
